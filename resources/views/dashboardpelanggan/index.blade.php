            ...
            <div class="col-md-4">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <p class="mt-3">Target Penggunaan Air: 1500 <span class="text-danger">Terlampaui</span></p>
                    </div>
                </div>
            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="input-group mb-3 mt-3">
                            <input type="text" class="form-control" placeholder="Penggunaan Air (m³)" aria-label="Penggunaan Air (m³)" aria-describedby="basic-addon2">
                            <div class="input-group-append">
                                <button class="btn btn-outline-success" type="button">Edit Target Air</button>
                            </div>
                        </div>
                    </div>
