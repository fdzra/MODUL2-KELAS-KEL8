...
<body id="page-top">
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-white sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link btn-info" href="/admin/petugas/kelolaPerangkat">
                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <p class="m-0 text-grey">KELOLA PERANGKAT</p>
                                    <h5 class="m-0 font-weight-bold text-dark">Daftar Perangkat</h5>
                                </div>
                                <div class="card-body">
                                    <table class="table table-sm">
                                        ...
                                        <tbody>
                                            ...
                                            @php
                                                $statusColor = '';
                                                switch($perangkat->status_perangkat) {
                                                    case 'Aktif':
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $perangkat->kecamatan }}</td>
                                                <td>
                                                    <span class="badge badge-{{ $statusColor }}">{{ $perangkat->status_perangkat }}</span>
                                                </td>
                                                <td>
