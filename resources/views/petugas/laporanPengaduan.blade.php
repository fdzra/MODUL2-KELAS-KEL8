        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Card Diatas Belum Diperoses, Sedang Diproses, dan Sudah Selesai -->
                    <div class="row">
                    ...
                    <!-- Card Table DaftarLaporan Pengaduan -->
                    <div class="row">
                                    ...
                                    <table class="table table-sm">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form action="{{ route('pengaduan.detail', $pengaduan->id_pelanggan) }}" method="POST">
                                                        @csrf
