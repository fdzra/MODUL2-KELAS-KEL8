...
<body id="page-top">
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-white sidebar sidebar-dark accordion" id="accordionSidebar">
            <a class="sidebar-brand d-flex align-items-center justify-content-center mt-4 p-3" href="/admin/petugas">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-light topbar pt-3 ml-3 mb-4 static-top">
                    <h1 class="h3 text-primary mt-4 mb-0"><b>Dashboard Petugas</b></h1>
                ...
                <div class="container-fluid">
                    <!-- Card diatas Belum Diproses, Sedang Diproses, Sudah Selesai -->
                    <div class="row">
                    ...
                    <!-- Tabel Daftar Request Pelanggan -->
                    <div class="row">
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <p class="m-0 text-grey">REQUEST PELANGGAN</p>
                                    <h5 class="m-0 font-weight-bold text-dark">Daftar Request</h5>
                                </div>
                                <div class="card-body">
