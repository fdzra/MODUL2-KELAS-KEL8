                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <p class="m-0 font-weight-bold text-dark">INFORMASI PELANGGAN</p>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        <div style="margin-left: 20px; margin-right: 20px;">
                                            ...
                                            <input type="text" id="disabledTextInput" class="form-control" placeholder="{{ $request->nama }}" disabled>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        <div style="margin-left: 20px; margin-right: 20px;">
                                            ...
                                            <input type="text" id="disabledTextInput" class="form-control" placeholder="{{ $request->kecamatan }}" disabled>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        <div style="margin-left: 20px; margin-right: 20px;">
                                            ...
                                            <input type="text" id="disabledTextInput" class="form-control" placeholder="{{ $request->alamat_lengkap }}" disabled>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        <div style="margin-left: 20px; margin-right: 20px;">
                                            ...
                                            <input type="text" id="disabledTextInput" class="form-control" placeholder="{{ $request->nomor_telepon }}" disabled>
                                        </div>
                                    </div>
                                </div>
                                <!-- <div class="col-lg-6">
                                        ...
                                        <div style="margin-left: 20px;">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="image-box" style="width: 500px;">
                                                    <img class="img-profile rounded" src="{{ asset('images/rumah.jpg') }}" style="width: 100%; height: 100%;" alt="Profil Picture">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
