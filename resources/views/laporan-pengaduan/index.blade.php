                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            <a href="/laporan-pengaduan/create" class="btn btn-success">Tambah Pengaduan <i class="fas fa-plus"></i></a>
                        </div>
                    </div>
                    <div class="card-body">
                        <table class="table" id="myTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="buttons">
                                            <a href="{{ route('laporan-pengaduan.show', $lp->id_pelanggan) }}" class="btn btn-primary btn-lg btn-block">Tampilkan Detail</a>
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
