        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                <nav class="navbar navbar-expand navbar-light bg-light topbar pt-3 ml-3 mb-4 static-top">
                    <h1 class="h3 text-primary mt-4 mb-0"><b>Tambah Petugas Baru</b></h1>
                        ...
                        <div class="col-lg-12">
                            <div class="card shadow mb-4">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h6 class="m-2 font-weight-bold">Buat Petugas Baru</h6>
                                </div> 
                                <div class="card-body">
                                    <form action="/admin/admin/insertkelolaPetugas" method="POST" enctype="multipart/form-data" >
                                        @csrf
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label for="inputname">Nama</label>
                                                <input type="name" class="form-control" name="petugas_name" id="inputname" placeholder="Masukkan nama admin baru">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="inputEmail4">Email</label>
                                                <input type="email" class="form-control" name="petugas_email" id="inputEmail4" placeholder="Masukkan email admin">
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-4">
                                                <label for="inputUsername">Username</label>
                                                <input type="text" class="form-control" name="petugas_username" id="inputUsername" placeholder="Masukkan username admin">
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label for="inputPassword">Password</label>
                                                <input type="text" class="form-control" name="petugas_password" id="inputPassword" placeholder="Masukkan password admin">
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label for="inputHandphone">Nomor Handphone</label>
                                                <input type="text" class="form-control" name="petugas_phone" id="inputHandphone" placeholder="Masukkan nomor handphone admin">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputKecamatan">Kecamatan</label>
                                            <input type="text" class="form-control" name="petugas_kecamatan" id="inputKecamatan" placeholder="Masukkan kecamatan admin">
                                        </div>
                                        <div class="form-group">
                                            <label for="inputAlamat">Alamat</label>
                                            <textarea class="form-control" name="petugas_alamat" id="inputAlamat" placeholder="Masukkan alamat lengkap admin" rows="3"></textarea>
                                        </div>
