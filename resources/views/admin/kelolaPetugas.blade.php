        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                <nav class="navbar navbar-expand navbar-light bg-light topbar pt-3 ml-3 mb-4 static-top">
                    <h1 class="h3 text-primary mt-4 mb-0"><b>Kelola Petugas</b></h1>
                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4">
                                <div class="header d-flex justify-content-between align-items-center">
                                    <h6 class="m-3 font-weight-bold">Daftar Petugas</h6>
                                    <a class="btn btn-success btn-sm mr-3" href="/admin/admin/addkelolaPetugas" role="button">Tambah +</a>
                                </div> 
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            @foreach ( $petugas as $p ) 
                                                <tr>
                                                    <th scope="row">{{$p->petugas_id}}</th>
                                                    <td>{{$p->petugas_name}}</td>
                                                    <td>{{$p->petugas_phone}}</td>
                                                    <td>{{$p->petugas_kecamatan}}</td>
                                                    <td>
                                                        <a class="btn btn-primary btn-sm" href="/admin/admin/editkelolaPetugas/{{$p->petugas_id}}" role="button">Tampilkan Detail</a>
                                                        <a href="/admin/admin/deletekelolaPetugas/{{$p->petugas_id}}" class="btn btn-danger btn-sm mr-2" onclick="return confirm('Apakah Anda yakin ingin menghapus petugas ini?')">Hapus Petugas</a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
