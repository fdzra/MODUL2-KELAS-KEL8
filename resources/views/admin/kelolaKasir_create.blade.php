        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                <nav class="navbar navbar-expand navbar-light bg-light topbar pt-3 ml-3 mb-4 static-top">
                    <h1 class="h3 text-primary mt-4 mb-0"><b>Tambah Kasir Baru</b></h1>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-12">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <form action="/admin/admin/insertkelolaKasir" method="POST" enctype="multipart/form-data" >
                                        @csrf
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label for="inputname">Nama</label>
                                                <input type="name" class="form-control" name="kasir_name" id="inputname" placeholder="Masukkan nama kasir baru">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="inputEmail4">Email</label>
                                                <input type="email" class="form-control" name="kasir_email" id="inputEmail4" placeholder="Masukkan email kasir">
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-4">
                                                <label for="inputUsername">Username</label>
                                                <input type="text" class="form-control" name="kasir_username" id="inputUsername" placeholder="Masukkan username kasir">
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label for="inputPassword">Password</label>
                                                <input type="text" class="form-control" name="kasir_password" id="inputPassword" placeholder="Masukkan password kasir">
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label for="inputHandphone">Nomor Handphone</label>
                                                <input type="text" class="form-control" name="kasir_phone" id="inputHandphone" placeholder="Masukkan nomor handphone kasir">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputAlamat">Alamat</label>
                                            <textarea class="form-control" name="kasir_alamat" id="inputAlamat" placeholder="Masukkan alamat lengkap kasir" rows="3"></textarea>
                                        </div>
