...
<body id="page-top">
    <div id="wrapper">
        ...
        <tr>
            ...
            <td>{{$j->alamat_pelanggan}}</td>
            <td>{{$j->kota_pelanggan}}</td>
            <td>{{$j->kecamatan_pelanggan}}</td>

            <td style="column-width: auto;">
                <div class="text-center">
                    <a type="button" class="btn btn-secondary text-center" href='/admin/admin/kelolaPelanggan/edit_pelanggan/{{$j->id_pelanggan}}'>Edit</a>
                </div>
                <div class="text-center">
                    <form action="/admin/admin/kelolaPelanggan/delete/{{$j->id_pelanggan}}" method="POST">
                        @csrf
                        @method('delete')
